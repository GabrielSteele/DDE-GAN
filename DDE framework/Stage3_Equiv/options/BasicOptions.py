...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_PET_CT', type=float, default=0.002, help='initial learning rate of net for adam')
        parser.add_argument('--lr_CT_PET', type=float, default=0.002, help='initial learning rate of net for adam')
        ...
        parser.add_argument('--task_name', type=str, default='PET-CT_lr-0.002_3', help='the current task name')
