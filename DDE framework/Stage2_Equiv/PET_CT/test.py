...
def test_result(parameter_path = 'latest_model_img.pth'):
    ...
    log_test = logger.Test_Logger(r'C:\Users\2418015\Downloads\Project_Results\Stage2_E\PET-CT_3\logger', "test_S2E_PET-CT_log")
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'C:\Users\2418015\Downloads\Project_Results\Stage2_E\PET-CT_3')
...
if __name__ == '__main__':
    test_result('best_model_img.pth') #  'best_model_img.pth'