...
def test_result(parameter_path = 'latest_model.pth'):
    ...
    log_test = logger.Test_Logger(r'C:\Users\2418015\Downloads\Project_Results\Stage3_E_E\PET-CT_3\logger', "test_pet-ct_log") # r'C:\Users\2418015\Downloads\Project_Results\Stage3_E_E\PET-CT\logger'
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'C:\Users\2418015\Downloads\Project_Results\Stage3_E_E\PET-CT_3') # r'C:\Users\2418015\Downloads\Project_Results\Stage3_E_E\PET-CT'
