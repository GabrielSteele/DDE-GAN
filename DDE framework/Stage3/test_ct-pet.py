...
def test_result(parameter_path = 'latest_model.pth'):
    ...
    log_test = logger.Test_Logger(r'C:\Users\2418015\Downloads\Project_Results\Stage3\CT-PET_3\logger', "test_ct-pet_log")
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'C:\Users\2418015\Downloads\Project_Results\Stage3\CT-PET_3')
    ...
    for img_dataset, file_idx in datasets:
        ...
        fake_PET = model(CT)
        test = torch.clamp(fake_PET, min=0)
