...
def test_result(parameter_path = 'latest_model.pth'):
    ...
    ckpt = torch.load(r'C:\Users\2418015\OneDrive - University of Dundee\Documents\4th Year\Project\Code\pythonProject\Dual_domain_Framework\Stage3_Equiv_No\checkpoints\CTimg_PETimg.pth')  # find and load the saved parameters into the model
    model.load_state_dict(ckpt['model'])

    #log_test = logger.Test_Logger(os.path.join(opt.checkpoints_dir,opt.task_name,'logger'), "test_pet-ct_log")
    log_test = logger.Test_Logger(r'D:\Project_Results\18_03_24\Paper\CT-PET\logger', "test_ct-pet_log")
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'D:\Project_Results\18_03_24\Paper\CT-PET')
    ...
    for img_dataset, file_idx in datasets:
        ...
        CT = CT.unsqueeze(0).type(torch.float32)
...
if __name__ == '__main__':
    test_result('best_model_CT_PET.pth') # C:\Users\2418015\OneDrive - University of Dundee\Documents\4th Year\Project\Code\pythonProject\Dual-domain Framework\Stage1\CTimg2PETimg\checkpoints\CT_img-PET_img\model
