...
def test_result(parameter_path = 'latest_model.pth'):
    ...
    ckpt = torch.load(r'C:\Users\2418015\OneDrive - University of Dundee\Documents\4th Year\Project\Code\pythonProject\Dual_domain_Framework\Stage3_Equiv_No\checkpoints\PETimg_CTimg.pth')
    model.load_state_dict(ckpt['model'])

    #log_test = logger.Test_Logger(os.path.join(opt.checkpoints_dir,opt.task_name,'logger'), "test_pet-ct_log")
    log_test = logger.Test_Logger(r'D:\Project_Results\18_03_24\Paper\PET-CT\logger', "test_pet-ct_log")
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'D:\Project_Results\18_03_24\Paper\PET-CT')
