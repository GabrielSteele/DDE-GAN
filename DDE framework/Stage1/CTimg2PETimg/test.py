...
#from DataloaderV3 import Lits_DataSet #
#from dataset.test_dataloaderV1 import Test_Datasets #
...
def test_result(parameter_path = 'latest_model.pth'):
    ...
    log_test = logger.Test_Logger(r'C:\Users\2418015\Downloads\Project_Results\Stage1\CTimg-PETimg_3\logger', "test_CTimg-PETimg_log")
    #save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'result')
    save_result_path = (r'C:\Users\2418015\Downloads\Project_Results\Stage1\CTimg-PETimg_3')
...
if __name__ == '__main__':
    test_result('best_model.pth') # C:\Users\2418015\OneDrive - University of Dundee\Documents\4th Year\Project\Code\pythonProject\Dual-domain Framework\Stage1\CTimg2PETimg\checkpoints\CT_img-PET_img\model
