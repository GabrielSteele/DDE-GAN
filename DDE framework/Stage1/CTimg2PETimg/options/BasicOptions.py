...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--batch_size', type=int, default=15, help='input train batch size') # default 11
        ...
        parser.add_argument('--task_name', type=str, default='CT_img-PET_img_3_1', help='the current task name')
